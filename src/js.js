...
function checaVencedor(){
    ...
    // após toda a checagem de vitória, o código verifica se houve empate
...
function reiniciar(){
    ...
    for (var i = 1; i <= 9; i++){
        ...
        // do jeito que essa estrutura está alocada, o for irá varrer todo o código para retorno inicial.
